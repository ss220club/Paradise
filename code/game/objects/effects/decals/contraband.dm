...
/obj/structure/sign/poster/secret/yug1
	name = "Красотка в пикантной позе"
	desc = "На плакате изображена сексуальная девушка в крайне пикнтной позе.\nНа ней какие-то следы, будто было что-то мокрое..."
